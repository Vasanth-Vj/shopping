...
import cartempty from "../assets/images/cartempty.jpeg";
      ...
      {cart.products.length > 0 ? (
        <div>
          ...
          <div className="flex flex-col md:flex-row justify-between space-x-10 mt-8">
            ...
            <div className="md:w-1/3 bg-white p-6 rounded-lg shadow-md border mt-5 md:mt-0">
              ...
              <button className="w-full bg-[#7FA1C3] text-white py-2 hover:bg-[#3f7ebd]">Checkout</button>
            </div>
          </div>
        </div>
      ) : (
